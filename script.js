...
/* === DOMAIN LOCK: Chỉ chạy trên domain được phép === */
(function(){const _h=window.location.hostname;const _p=window.location.protocol;const _ALLOWED=['mrkhang-khoi.github.io','localhost','127.0.0.1'];if(_p==='file:'||(!_ALLOWED.some(d=>_h===d||_h.endsWith('.'+d)))){document.addEventListener('DOMContentLoaded',function(){document.body.innerHTML='<div style="display:flex;align-items:center;justify-content:center;min-height:100vh;background:#0f172a;color:#e2e8f0;font-family:Inter,sans-serif;text-align:center;padding:20px"><div><h1 style="font-size:3rem;margin-bottom:16px">⛔</h1><h2 style="font-size:1.4rem;font-weight:700;margin-bottom:12px">Không được phép truy cập</h2><p style="color:#94a3b8;font-size:.9rem;max-width:500px;line-height:1.6">Ứng dụng này chỉ hoạt động trên domain chính thức.<br>Vui lòng truy cập: <a href=\"https://mrkhang-khoi.github.io/python/\" style=\"color:#818cf8\">mrkhang-khoi.github.io/python</a></p><p style="color:#475569;font-size:.7rem;margin-top:16px">© Themis Online Judge — Bản quyền được bảo vệ</p></div></div>'});throw new Error('DOMAIN_LOCK: Unauthorized domain: '+_h)}})();
